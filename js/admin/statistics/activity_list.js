...
$(document).ready(function(){
	...
	$('#activity_list_tab').datagrid({  
	    url:'/statistics/activityList',   
	    columns:[[ 
	        {field:'date_statis',title:'时间',width:100,align:'center'},
	        {field:'day_activity_sum',title:'活动数',width:200,align:'center'},
	        ...
	        {field:'all_day_activity_sum',title:'活动总数',width:200,align:'center'},
...
//        	 handler:edit_view}
	...
	//page
    var p = $('#activity_list_tab').datagrid('getPager');  
    $(p).pagination({  
    ...
    function show_view(){ 
		$.ajax({ 
	        ...
	        contentType : 'application/x-www-form-urlencoded; charset=UTF-8',
	         url:  "/statistics/get_activity_statistics",
	         data: {}, 
	         dataType: 'text', 
