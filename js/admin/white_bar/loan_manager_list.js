...
$(document).ready(function(){
	...
	$('#sponsor_apply_list_tab').datagrid({  
	    url:'/Loan/query_page?time='+new Date(),   
	    columns:[[ 
	        ...
	        {field:'apply_status',title:'申请状态',width:200,align:'center',formatter:formatStatus}, 
	        {field:'apply_date',title:'申请时间',width:200,align:'center',formatter:formatTime},
	        {field:'wxchat',title:'微信号',width:200,align:'center'},
	        {field:'loan_type',title:'贷款类型',width:200,align:'center',formatter:loan_type},
	        {field:'address',title:'申请人地址',width:200,align:'center'},
	    ]],
	    loadMsg:"数据加载中请稍后!",
	    fitColumns:true,
	    striped:true,
    ...
    function detail(){
    	...
    	$("#loan_type").html(loan_type(obj.loan_type));
	...
	function selectSponsorApply() {
		...
		queryParams.apply_status = $("#apply_status").combobox('getValue'); 
		queryParams.id=$("#number").val();
	...
	function shenhe() {
		...
		var id = $('#id').val();
		var apply_status = $('input:radio[name="apply_status"]:checked').val();
		$.ajax({ 
	        type: "POST", 
	        contentType : 'application/x-www-form-urlencoded; charset=UTF-8',
	         url:  "/Loan/update",
