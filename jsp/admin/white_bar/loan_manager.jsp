...
<script src="/js/admin/white_bar/loan_manager_list.js"></script>
</head>
<style>
	.shenhe_ul li{
		text-align:center;
...
<body style="padding:0;">
	...
	<div class="easyui-panel" title="贷款管理"    
    	...
    	<p style="display: block; line-height: 20px; height: 20px; text-align: center;">
    		<span> <label>贷款编号:</label></span>
    		<input class="easyui-validatebox" type="text" id="number" />
    		<span> <label>电话号码:</label></span>
    		<input class="easyui-validatebox" type="text" id="phone" />
    		<select  class="easyui-combobox" style="width: 160px;" id="apply_status" panelHeight="100" >
				<option value="">全部</option>
				<option value="1">申请</option>
				<option value="2">审核中</option>
				<option value="3">可以放款</option>
			</select>
	...
	<div id="shenhe_win">
		<ul class="shenhe_ul">
			<li>
				...
				<input name="apply_status" type="radio" value="2"/>审核成功 &nbsp;&nbsp;&nbsp;&nbsp;
				<input name="apply_status" type="radio" value="3" checked="checked" />审核失败&nbsp;&nbsp;&nbsp;&nbsp;
				<input name="apply_status" type="radio" value="4" checked="checked" />已放款&nbsp;&nbsp;&nbsp;&nbsp;
			</li>
	...
	<div id="detail">
	 <ul class="shenhe_ul">
			...
			<li>
				<span>申请金额:</span>
				<span id="apply_money"></span>元
			</li>
			<li>
				<span>贷款类型:</span>
				<span id="loan_type"></span>
			</li>
			<li>
