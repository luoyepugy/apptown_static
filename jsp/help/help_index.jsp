...
<html lang="zh-CN">
  <head>
    ...
    <style>
	    #tab11 li{width:766px;height:1660px;}
	    #tab11 li img{width:766px;height:1660px;}
    </style>
  </head>
  <body>
	<%@include file="/jsp/common/mml_nav.jsp"%>
	<input type="hidden" id="helpTab" value="${tabnub }">
    <div class="breadcrumb-box">
      <ol class="breadcrumb">
        <li><a href="#">帮助</a></li>
        <li class="active">关于慢慢来</li>
      </ol>
    </div> <!--/////////////breadcrumb end!////////////-->

    <div class="w-1080 mgt-20">

      <aside class="w-218">
        <div id="myTabs" class="list-group"  role="tablist">
          <a role="tab" href="#tab1" id="tab1-tab" data-toggle="tab" aria-controls="tab1" class="list-group-item">关于慢慢来</a>
          <a role="tab" href="#tab2" id="tab2-tab" data-toggle="tab" aria-controls="tab2" class="list-group-item">e币是什么</a>
          <a role="tab" href="#tab3" id="tab3-tab" data-toggle="tab" aria-controls="tab3" class="list-group-item">帮助/常见问题</a>
          <a role="tab" href="#tab11" id="tab11-tab" data-toggle="tab" aria-controls="tab11" class="list-group-item">怎么添加视频</a>
          <a role="tab" href="#tab4" id="tab4-tab" data-toggle="tab" aria-controls="tab4" class="list-group-item">积分说明</a>
          <a role="tab" href="#tab5" id="tab5-tab" data-toggle="tab" aria-controls="tab5" class="list-group-item">产品应用/特点</a>
          <a role="tab" href="#tab6" id="tab6-tab" data-toggle="tab" aria-controls="tab6" class="list-group-item">慢慢来团队</a>
          <a role="tab" href="#tab7" id="tab7-tab" data-toggle="tab" aria-controls="tab7" class="list-group-item">加入我们</a>
          <a role="tab" href="#tab8" id="tab8-tab" data-toggle="tab" aria-controls="tab8" class="list-group-item">联系我们</a>
        </div><!--/////////TAB NAV END/////////-->
        ...
        <div id="myTabContent" class="tab-content">
          ...
          <ul role="tabpanel"  class="list-unstyled col-md-11 tab-pane fade" id="tab4" style="margin-left:30px;">
            <h3 role="tablist" id="myTabs">
              <a role="tab" href="#tab9" id="tab9-tab" data-toggle="tab" aria-controls="tab9" class="text-muted" style="margin-right:70px; cursor:pointer;"><b>关于积分说明</b></a>
              <a role="tab" href="#tab10" id="tab10-tab" data-toggle="tab" aria-controls="tab10" class="text-muted" style="cursor:pointer;"><b>积分详情说明</b></a>
            </h3>
            <hr>
            ...
            <div class="firstpage">
              ...
              <div class="media" style="background:#f8f8f8; border-radius:4px; margin:20px auto;">
                ...
                <div class="media-body">
                  <h4 class="media-heading"><b>陈金兰</b></h4>
              ...
              <div class="media" style="background:#f8f8f8; border-radius:4px; margin:20px auto;">
                ...
                <div class="media-body">
                  <h4 class="media-heading"><b>彭前庆</b></h4>
              ...
              <div class="media" style="background:#f8f8f8; border-radius:4px; margin:20px auto;">
                ...
                <div class="media-body">
                  <h4 class="media-heading"><b>郭嘉琪</b></h4>
              ...
              <div class="media" style="background:#f8f8f8; border-radius:4px; margin:20px auto;">
                ...
                <div class="media-body">
                  <h4 class="media-heading"><b>陈智敏</b></h4>
              ...
              <div class="media" style="background:#f8f8f8; border-radius:4px; margin:20px auto;">
                ...
                <div class="media-body">
                  <h4 class="media-heading"><b>赖汉臻</b></h4>
              ...
              <div class="media" style="background:#f8f8f8; border-radius:4px; margin:20px auto;">
                ...
                <div class="media-body">
                  <h4 class="media-heading"><b>叶学忠</b></h4>
              ...
              <div class="media" style="background:#f8f8f8; border-radius:4px; margin:20px auto;">
                ...
                <div class="media-body">
                  <h4 class="media-heading"><b>陈伟雄</b></h4>
    ...
    $(document).ready(function(){
    	$('.mml-nav-top').removeClass('active').eq("5").addClass('active');
    	
    	if($('#helpTab').val() !=""){
    		$('.list-unstyled').removeClass('active').removeClass('in');
    		$("#tab"+$('#helpTab').val()+"").addClass('active').addClass('in');
    		if($('#helpTab').val()=="4"){
    			$("#tab9").addClass('active').addClass('in');
    		}
    	}
    })
    </script>
